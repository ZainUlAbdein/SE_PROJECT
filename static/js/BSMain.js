...
//     "http://www.pdfdrive.com/" + result + "-books.html";
// }

// var body1 = document.body;
// function tolocal() {
//   body1.style.backgroundColor = "#bf884d";
// }
// function toyt() {
//   body1.style.backgroundColor = "#ea4343";
// }

// gapi.load("client", loadClient);

// var dataJSON =
//   '[{"kind": "youtube#searchResult","etag": "Bc5VT1AbYbC01s11ibAIwx4a-Q0","id": {"kind": "youtube#video","videoId": "FkQuawiGWUw" },"snippet": {"publishedAt": "2016-09-07T15:32:53Z","channelId": "UCuasRuWliU48RwnKXf9GesA","title": "Divi. The Ultimate WordPress Theme And Visual Page Builder","description": "Try it for free today: ...","thumbnails": {"default": {"url": "https://i.ytimg.com/vi/FkQuawiGWUw/default.jpg","width": 120,"height": 90},"medium": {"url": "https://i.ytimg.com/vi/FkQuawiGWUw/mqdefault.jpg","width": 320,"height": 180},"high": {"url": "https://i.ytimg.com/vi/FkQuawiGWUw/hqdefault.jpg","width": 480,"height": 360}},"channelTitle": "Elegant Themes","liveBroadcastContent": "none","publishTime": "2016-09-07T15:32:53Z"}}]';

// function loadClient() {
//   gapi.client.setApiKey("AIzaSyDX7r8RJvBeFT4hhyOmz3eqO7PkrIX4S4A");
//   return gapi.client
...
//           itemElement.innerHTML = `<div class='holder'><img src='${item.snippet.thumbnails.default.url}'></img><h4 class='holderh'>${item.snippet.title}</h4></div>`;
//           itemElement.addEventListener("click", () => {
//             console.log(item.id.videoId);
//             document.getElementById(
//               "ifr"
//             ).innerHTML = `<iframe class='iframer' src='http://www.youtube.com/embed/${item.id.videoId}'></iframe>`;
//           });
